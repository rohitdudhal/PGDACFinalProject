...
import com.fashionsuperior.models.AdminDto;
import com.fashionsuperior.models.LoginDTO;
import com.fashionsuperior.models.Response;
import com.fashionsuperior.service.AdminService;
...
public class AdminController {
	...
	public ResponseEntity<?>forgetPassword(@RequestBody AdminDto adminDto) throws MessagingException {	
		...
		emailService.sendOtp(adminDto.getEmail(),"OTP: "+otp,"OTP Verification! FashionSuperior! ");
