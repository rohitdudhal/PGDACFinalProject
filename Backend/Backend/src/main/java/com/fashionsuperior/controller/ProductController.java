...
import com.fashionsuperior.models.ProductDto;
import com.fashionsuperior.models.ProductPagedResponseDTO;
import com.fashionsuperior.models.ProductResponseDto;
...
public class ProductController {
	...
	@GetMapping("/products")
	public ResponseEntity<?> findProductByCategoryHandler(@RequestParam String category,
			@RequestParam List<String> colour, @RequestParam Double minPrice, @RequestParam Double maxPrice,
			@RequestParam String sort, @RequestParam Integer pageNumber, @RequestParam Integer pageSize) {


		Page<Product> res = productService.getAllProduct(category, colour, minPrice, maxPrice, sort, pageNumber,
				pageSize);
